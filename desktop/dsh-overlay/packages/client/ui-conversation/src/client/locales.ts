...
export const zh = {
  ...
  'placeholder.hero': '描述你的科研任务，或从上方选择一个模块',
  ...
  'hero.kicker': '大黄鱼智慧选育 · 科研办公 · 开放式智能体',
  'hero.headline': '今天，从哪项科研工作开始？',
  'hero.preview': '科研版',
  'hero.intro': '鲲鹏以 Harness 插件体系为底层，连接课题组知识、受控分析流程与育种数据。模型负责理解与编排，证据、算法和人工审核负责科研结论。',
  'hero.modules': '科研功能模块',
  'hero.principle.evidence': '证据可追溯',
  'hero.principle.reproducible': '计算可复现',
  'hero.principle.explainable': '决策可解释',
  'hero.principle.governed': '数据可治理',
  'hero.module.literature': '文献证据检索',
  'hero.module.literature.desc': '核验 DOI、原文证据与结论边界',
  'hero.module.daily': '每日科研办公',
  'hero.module.daily.desc': '实验、会议、材料与项目行动清单',
  'hero.module.omics': '组学分析工作流',
  'hero.module.omics.desc': '输入质控、参数确认与复现记录',
  'hero.module.data': '育种数据治理',
  'hero.module.data.desc': '个体、样本、表型和基因型标准化',
  'hero.module.gs': '全基因组选育',
  'hero.module.gs.desc': 'GEBV、模型验证与多性状选择',
  'hero.module.writing': '科研写作',
  'hero.module.writing.desc': '论文、项目、汇报与审稿回复',
  'hero.chooseWorkspaceFirst': '先选择工作区，即可将科研任务模板写入对话框。',
...
export const en = {
  ...
  'placeholder.hero': 'Describe your research task, or choose a module above',
  ...
  'hero.kicker': 'GENOMIC SELECTION · RESEARCH OPERATIONS · OPEN AGENTS',
  'hero.headline': 'What will you work on today?',
  'hero.preview': 'Research',
  'hero.intro': 'Kunpeng uses the Harness plugin system to connect lab knowledge, governed workflows, and breeding data. The model interprets and orchestrates; evidence, algorithms, and human review establish scientific conclusions.',
  'hero.modules': 'Research modules',
  'hero.principle.evidence': 'Traceable evidence',
  'hero.principle.reproducible': 'Reproducible computation',
  'hero.principle.explainable': 'Explainable decisions',
  'hero.principle.governed': 'Governed data',
  'hero.module.literature': 'Evidence search',
  'hero.module.literature.desc': 'Verify DOI, source evidence, and claim boundaries',
  'hero.module.daily': 'Daily research work',
  'hero.module.daily.desc': 'Experiments, meetings, materials, and projects',
  'hero.module.omics': 'Omics workflows',
  'hero.module.omics.desc': 'Input QC, parameters, and reproducibility records',
  'hero.module.data': 'Breeding data',
  'hero.module.data.desc': 'Standardize individuals, samples, phenotypes, and genotypes',
  'hero.module.gs': 'Genomic selection',
  'hero.module.gs.desc': 'GEBV, validation, and multi-trait selection',
  'hero.module.writing': 'Scientific writing',
  'hero.module.writing.desc': 'Papers, proposals, reports, and responses',
  'hero.chooseWorkspaceFirst': 'Choose a workspace to insert a reviewed research-task starter.',
